  ...
  <main class="container">
    ...
    <nav style="margin-left: 2rem">
      <ul>
        ...
        <li>
          <a href="https://twitter.com/nexmoe" target="_blank">Twitter</a>
        </li>
        <li>
          <a href="https://github.com/xiaoshuapp/explorer-xiaoshu/issues" target="_blank">反馈 / Issue</a>
        </li>
      </ul>
    </nav>
    <h2>UI / 界面设置</h2>
    <hr>
    <p>
      <label><input v-model="setting.hidden" type="checkbox"> Put it away
        deeper / 收起得更深</label>
    </p>
    <p>
      <label><input v-model="setting.right" type="checkbox"> Show on the
        right / 显示在右边</label>
    </p>
    <h2>Functions / 功能设置</h2>
    <hr>
    <p>
      <label><input v-model="setting.function.openNew" type="checkbox">
        Open in new tabs / 在新标签页打开</label>
    </p>
    <p>
      <label><input v-model="setting.function.automaticAdvance" type="checkbox">
        Automatic advance / 相关分组自动提前</label>
    </p>
    <p>
      <label><input v-model="setting.function.getSelection" type="checkbox">
        Get the selected words / 划词召唤探索者小舒</label>
    </p>
    <p>
      <label><input v-model="setting.function.enableOnly" type="checkbox">
    ...
    <article>
      ...
      <div>
        ...
        <p>
          官网链接：<a href="https://xiaoshu.app" target="_blank">https://xiaoshu.app</a>
        </p>
        <p>
          <img
            width="100%"
    ...
    <article>
      ...
      <div>
        <p>
          Channel:
          <a href="https://t.me/explorer_xiaoshuc" target="_blank">https://t.me/explorer_xiaoshuc</a>
        </p>
      </div>
    </article>
    <p>
      ...
      With
      <a href="https://github.com/nexmoe/nexmoe.css" target="_blank">Nexmoe.css</a>
    </p>
    <div v-if="saveInfo" class="alert">
      设置已保存！
    </div>
  </main>
</template>
